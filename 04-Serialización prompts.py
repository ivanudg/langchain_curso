...
prompt.save("plantillas_prompts/prompt.json") #Guardamos la plantilla en un archivo JSON

prompt_cargado = load_prompt("plantillas_prompts/prompt.json") #Cargamos la plantilla desde el archivo JSON
